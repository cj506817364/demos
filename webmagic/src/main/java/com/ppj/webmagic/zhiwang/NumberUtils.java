...
public class NumberUtils {
    ...
    private static int numberCharCN2Arab(char onlyCNNumber) {
    ...
    private static String numberArab2CN(Integer num) {
...
//去掉未位的零
    ...
    public static String numberKCN2Arab(String numberCN) {
