package com.ppj.webmagic.aiqiyi;
...
public class SpiderAiqiyiDanMu {
    ...
    public static void main(String[] args) {
        String url = "https://www.iqiyi.com/v_19rrkwxzv8.html";
    ...
    private static String httpGetRequest(String url, boolean needUnzip) {
        try {
            if (needUnzip) {
                return new String(ZipUtil.unZlib(HttpUtil.createGet(url).execute().bodyStream()));
            }
