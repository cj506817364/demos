...
public class ResumePostCreator {
  ...
  public static final String POST_ID = "1468471600435757057";
  public static final Integer SENDER_ID = 108430;
...
//    createForStatus(postCategoryId, post, 0, 1);
  ...
  public static void create(String resumeId, Integer userId, String postCategoryId,
    ...
    // 创建投递信息
    exec(
        "INSERT INTO `uwa-recruit-test`.resume_post (id, resume_snapshot_id, resume_id, post_id, post_owner_id, resume_owner_id, status, collect, create_time, update_time, updater_id, is_delete) VALUES "
  ...
  public static void createUserInfo(Integer userId, boolean needBasic) throws SQLException {
    ...
    // 创建用户求职信息
    exec(
        "INSERT INTO `uwa-recruit-test`.user_job_info (user_id, sex, birthday, job_identity, job_time, province_id, city_id, phone, email, view_num, invited_num, delivered_num, create_time, update_time) VALUES "
            + "(" + userId
  ...
  public static void createResume(String resumeId, Integer userId, String postCategoryId, String postName)
    ...
    exec(
        "INSERT INTO `uwa-recruit-test`.resume (resume_id, user_id, advantage, job_status, is_open, job_month, is_complete, create_time, update_time)"
            + " VALUES ('{}', {}, '我腿特长', 0, 0, 0, 1, '2021-11-16 20:38:33', '2021-11-22 14:49:41');",
        resumeId, userId);
    /// 创建求职期望
    exec(
        "INSERT INTO `uwa-recruit-test`.job_expect (resume_id, user_id, post_category_id, position_name, province_id, city_id, salary_min, salary_max, salary_num, create_time, update_time) VALUES "
            + "('{}', {}, '{}', '{}', 310000, 310100, 1, 2, 12, '2021-11-22 14:48:25', '2021-11-24 15:09:38');",
        resumeId, userId, postCategoryId, postName + "下的一个职位");
    // 创建教育经历
    exec(
        "INSERT INTO `uwa-recruit-test`.education_experience (education_experience_id, resume_id, user_id, school_name, degree, field_of_study, start_time, end_time, is_end_today, create_time, update_time, order_by) VALUES "
    ...
    // 创建工作经历
    exec(
        "INSERT INTO `uwa-recruit-test`.job_experience (job_experience_id, resume_id, user_id, company_name, start_time, end_time, is_end_today, post_category_id, position_name, month_salary, order_by, create_time, update_time) VALUES "
    ...
    // 创建项目经历
    exec(
        "INSERT INTO `uwa-recruit-test`.project_experience (project_experience_id, resume_id, user_id, name, start_time, end_time, is_end_today, description, duty, result, order_by, create_time, update_time) VALUES "
